 ...
 * @author matsumana
 */
public class Table0DaoTest {

    Table0Dao sut = new Table0DaoImpl(AppConfig.singleton());
    ...
    public void insertAndSelectTest() {
        tm.required(() -> {
            ...
            // SELECT
            Table0 actual = sut.selectById(new BigInteger("1"));
            ...
            assertThat(actual.getColDoublePrecisionUnsigned(), is(Double.valueOf(25)));
            assertThat(actual.getColDate(), is(LocalDate.of(2016, 4, 4)));
            assertThat(actual.getColDate(), is(LocalDate.of(2016, 4, 4)));
            assertThat(actual.getColDatetime(), is(LocalDateTime.of(2016, 4, 5, 12, 34, 56)));
            assertThat(actual.getColTimestamp(), is(LocalDateTime.of(2016, 4, 6, 12, 34, 57)));
