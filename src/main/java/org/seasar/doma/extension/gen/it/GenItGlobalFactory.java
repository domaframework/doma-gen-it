...
public class GenItGlobalFactory extends GlobalFactory {
    ...
    public DataSource createDataSource(Driver driver, String user,
        ...
        DataSource dataSource = super.createDataSource(driver, user, password,
                url);
        ...
        try {
            ...
            try {
                ...
                statement
                        .executeUpdate("create table varchar_table (varchar_column varchar(20), version integer)");
                statement
                ...
                statement
                        .executeUpdate("create table varbinary_table (varbinary_column varbinary(100), version integer)");
                statement
